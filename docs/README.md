...
Each slice's spec is kept, with where the build differs at the top. Read before touching logging,
the control template, the join material, or Grafana sign-in. Build plans, task by task:
