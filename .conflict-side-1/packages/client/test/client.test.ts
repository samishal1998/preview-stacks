...
describe('the client speaks the real API', () => {
  ...
  test('submit, read, act, and forget a deployment', async () => {
     ...
     * installed. It failed on every push. The guard itself is pinned deterministically in
     * packages/conformance, which drives a FAKE docker and can therefore choose the answer.
     */
